...
## 1. מערכת מדידת הצון (Cun)

### 1.1 מהו צון?

**צון** (Cun, לעיתים מתורגם "אינץ' סיני") הוא יחידת מדידה **יחסית** - המבוססת על גוף המטופל עצמו. צון אחד שונה מאדם לאדם, ומבטיח שנקודות הדיקור נמצאות באותו מיקום יחסי על כל אדם, ללא קשר לגודלו.
...
### 1.3 מדידה יחסית (Gu Du Fen Cun Fa)
...
| מ- | עד | מרחק |
|---|---|---|
| קו השיער הקדמי | קו השיער האחורי | 12 צון |
| בין שני קצוות הגבות | קו השיער הקדמי | 3 צון |

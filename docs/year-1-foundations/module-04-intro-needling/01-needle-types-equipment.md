...
|---|---|---|---|
| **חוד** (Zhen Jian) | Tip | קצה חד, מעוגל קלות ("דמוי אורן") | חדירה לעור ברכות |
| **גוף** (Zhen Shen) | Body/Shaft | חלק ארוך ודק מפלדת אל-חלד | חודר לרקמה |
| **שורש** (Zhen Gen) | Root | נקודת חיבור בין גוף לידית | נקודת מעבר, חייבת להיות חלקה |
| **ידית** (Zhen Bing) | Handle | חלק עבה יותר, לרוב מתכת מלופפת | אחיזה, סיבוב, מניפולציה |
| **זנב** (Zhen Wei) | Tail | קצה עליון של הידית | ניתן לחבר אלקטרודות, מוקסה |

### 1.2 סוגי חודים

- **חוד מעוגל** (Song Zhen Xing, "דמוי אורן") - הסטנדרט. חודר ללא חיתוך רקמה
...
### 2.2 כסף (Silver - Yin Zhen)

- שימוש מסורתי, בעיקר בסין
- מוליכות חום גבוהה - משמשות עם מוקסה מחוממת
- יקרות, רכות, מתעקלות בקלות
- כיום: שימוש נדיר, בעיקר בטכניקות "מחט אש"

### 2.3 זהב (Gold - Jin Zhen)

- שימוש מסורתי לחיזוק (Bu Fa)
- יקרות מאוד, רכות
...
### 5.2 מוקסה (Ai Jiu / Moxa)

- צמח ארטמיסיה (Artemisia Vulgaris / Ai Cao) מיובש ודחוס
- **סוגים**:
  - **מוקסה ישירה** - חרוט קטן על העור (פחות נפוץ כיום)
  - **מוקסה עקיפה** - חרוט על פרוסת ג'ינג'ר/שום/מלח
  - **סיגר מוקסה** (Ai Tiao) - מקרבים לעור ללא מגע
  - **מוקסה על המחט** (Wen Zhen Jiu) - כדור מוקסה על ידית המחט
- **שימוש**: חימום, חיזוק יאנג, פיזור קור, חיזוק צ'י

### 5.3 כוסות רוח (Ba Guan / Cupping)

- כוסות זכוכית, פלסטיק או סיליקון ליצירת ואקום על העור
- **סוגים**:
  - כוסות אש - ואקום באמצעות אש
  - כוסות שאיבה - ואקום באמצעות משאבה
  - כוסות סיליקון - ואקום באמצעות לחיצה
- **שימוש**: הסרת סטגנציה, שחרור שרירים, הסרת רוח-קור

### 5.4 מחטי לחץ (Press Tacks / Pi Nei Zhen)

- מחטים זעירות (0.6-1.5 מ"מ) מוצמדות לפלסטר
- נשארות בעור 1-5 ימים
- שימוש: נקודות אוזן, טיפול ממושך, גמילה מעישון
- סוגים:
  - **Ear Seeds** (Er Xue Tie) - כדורי מתכת/זרעונים על פלסטר (ללא חדירה)
  - **Intradermal Needles** - מחטים שטוחות שחודרות 1-2 מ"מ

### 5.5 מחטי עור (Dermal Needles - Pi Fu Zhen)

- **פטיש שבע כוכבים** (Qi Xing Zhen / Plum Blossom Needle) - ראש עם 7 מחטים קטנות
- **פטיש שזיף** (Mei Hua Zhen) - ראש עם 5 מחטים
- שימוש: טפטוף קל על העור לאורך ערוצים, גירוי שטחי
- מתאים לילדים, לאזורים רגישים, לבעיות עור

### 5.6 ציוד לאלקטרו-אקופונקטורה (Dian Zhen)

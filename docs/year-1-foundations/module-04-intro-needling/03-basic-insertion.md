...
### 1.3 החדרה שטוחה / רוחבית (Ping Ci) — 15°
...
- **טכניקה מיוחדת**: "דיקור שרשור" (Tou Ci) — מחט אחת חודרת מנקודה אחת לכיוון נקודה אחרת מתחת לעור
...
### 3.1 החדרה ביד אחת (Dan Shou Jin Zhen)
...
### 3.2 החדרה בשתי ידיים (Shuang Shou Jin Zhen)

**תיאור**: יד אחת מחדירה, היד השנייה מסייעת.

#### שיטת לחיצת עור (An Ya Fa)
...
### 5.1 הרמה ודחיפה (Ti Cha / Lifting-Thrusting)
...
- **משמעות טיפולית**:
  - דחיפה חזקה + הרמה עדינה = **חיזוק** (Bu Fa)
  - הרמה חזקה + דחיפה עדינה = **פיזור** (Xie Fa)

### 5.2 סיבוב (Nian Zhuan / Rotating)
...
## 6. זמן החזקת מחטים (Liu Zhen / Needle Retention)
...
| חיזוק | 15-20 דקות | עדין וקצר יחסית |
| פיזור | 25-40 דקות | חזק וארוך יחסית |
...
## 7. הוצאת מחטים (Chu Zhen / Needle Removal)
...
- **לחיזוק**: לחצו ועסו את הנקודה לאחר הוצאה ("סגירת הנקודה")
- **לפיזור**: אל תלחצו — השאירו את הנקודה "פתוחה" לפיזור

...
| פרט | תיאור |
| -------------------- | ------------------------------ |
| **שם סיני** | (Shǒu Shào Yīn Xīn Jīng) |
| **קיצור** | HT (Heart) |
| **מספר נקודות** | 9 |
| **סוג** | ין (Yin) |
| **אלמנט** | אש (Huǒ) |
| **זוג פנימי-חיצוני** | מעי דק (SI) |
...
הערוץ מתחיל ב**לב** (Xīn), יוצא ממנו ומתפצל לשלושה ענפים:

1. **ענף יורד**: יורד דרך הסרעפת ומתחבר אל **המעי הדק** (Xiǎo Cháng) - איבר הפו המזווג
2. **ענף עולה**: עולה מהלב לאורך הגרון ומגיע אל **העין** (Mù Xì - "קשר העין")
3. **ענף לטרלי**: יוצא מהלב לריאות, חוצה את השחי ויוצא ב-HT1 - כך מתחבר למסלול החיצוני

#### 1.3 זיווג פנימי-חיצוני

ערוץ הלב (ין) מזווג עם ערוץ המעי הדק (יאנג). שניהם שייכים לאלמנט האש (Huǒ):

* **הלב** (ין) - שולט על הדם וכלי הדם, מאכלס את הרוח (שן)
* **המעי הדק** (יאנג) - מפריד בין טהור לעכור, מעביר נוזלים לשלפוחית

הקשר הקליני: חום בלב (Xīn Huǒ) יכול לרדת למעי הדק ולגרום לתסמיני חום בדרכי השתן (צריבה בהשתנה, דם בשתן).
...
1. **שולט על הדם וכלי הדם** (Zhǔ Xuè Mài): הלב מניע את הדם בכלי הדם. כוח הלב = דופק תקין, מחזור דם תקין.
2. **מאכלס את הרוח** (Cáng Shén): הלב הוא "הארמון" שבו שוכנת הרוח (Shén) - ההכרה, החשיבה, הזיכרון, השינה, והרגשות. כאשר הלב חזק, הרוח יציבה - שינה טובה, חשיבה ברורה, רגשות מאוזנים.
3. **נפתח בלשון** (Kāi Qiào Yú Shé): מצב הלב משתקף בלשון - צבעה, תנועתה ויכולת הדיבור. לשון אדומה עם קצה אדום = חום בלב. גמגום או קושי בדיבור = חסימת ערוץ הלב.
4. **מתגלה בפנים** (Qí Huá Zài Miàn): צבע הפנים משקף את מצב הלב. פנים ורודות = לב בריא. פנים חיוורות = חסר דם הלב. פנים כהות/סגולות = סטגנציה של דם.
5. **שולט על הזיעה** (Hàn Wéi Xīn Zhī Yè): "הזיעה היא נוזל הלב" - הזעה מוגזמת פוגעת בצ'י ובין הלב.

#### 2.2 פתולוגיות נפוצות

| פתולוגיה | סימנים עיקריים |
| ----------------------------- | ---------------------------------------------------------------- |
| **חסר צ'י הלב** | דפיקות לב, קוצר נשימה במאמץ, עייפות, הזעה ספונטנית, פנים חיוורות |
| **חסר יאנג הלב** | כל הנ"ל + קרירות בגפיים, פנים חיוורות-כחלחלות, כאבי חזה |
| **חסר דם הלב** | דפיקות לב, חיוורון, סחרחורת, שכחנות, נדודי שינה, חלומות מרובים |
| **חסר ין הלב** | דפיקות לב, נדודי שינה, הזעות לילה, חום בכפות ידיים, אי-שקט |
| **אש הלב עולה** | כיבים בפה ובלשון, אי-שקט, נדודי שינה, פנים אדומות, צמא |
| **חסימת דם הלב** | כאבי חזה דוקרניים (כמו דקירת סיכה), שפתיים כהות, לשון סגולה |
| **ליחה מטשטשת את הלב** | בלבול, דיבור לא קוהרנטי, הזיות, אפילפסיה, קהות חושים |
...
**קטגוריה מיוחדת**: **נקודת לואו-מחברת** (Luò Xué) - מתחברת לערוץ המעי הדק (SI)
...
* **נקודת מפתח להזעות לילה** (Dào Hàn) - הנקודה היעילה ביותר להזעות לילה מחסר ין
* מזינה ין הלב - חום בלילה, חום בכפות ידיים, אי-שקט
* מפנה חום ריק (Xū Rè) מהלב
* מקררת דם - דימום אף, הקאת דם
* מרגיעה את הרוח - פחד פתאומי, חרדת לילה
* כאבי לב חריפים

**קטגוריה מיוחדת**: **נקודת שי-צ'לפט** (Xì Xué) - יעילה במיוחד למצבים חריפים ולכאב
...
* **נקודת המפתח להרגעת הרוח** (Ān Shén) - הנקודה הנפוצה ביותר לנדודי שינה, חרדה, ודפיקות לב
...
**קטגוריה מיוחדת**: נקודת שו-זרם (Shū) - אלמנט אדמה; **נקודת יואן-מקור** (Yuán Xué); נקודת סדציה (Xiè Xué)
...
| נקודה | סוג | אלמנט |
| --------------- | -------------- | ----- |
| HT9 (שאו צ'ונג) | ג'ינג-באר | עץ |
| HT8 (שאו פו) | יינג-מעיין | אש |
| HT7 (שן מן) | שו-זרם | אדמה |
| HT4 (לינג דאו) | ג'ינג-נהר | מתכת |
| HT3 (שאו האי) | הה-ים | מים |

#### נקודות מיוחדות נוספות

| נקודה | קטגוריה |
| ------------- | ----------------------------- |
| HT7 (שן מן) | יואן - מקור; שו-זרם |
| HT5 (טונג לי) | לואו - מחברת |
| HT6 (ין שי) | שי - צ'לפט |
...
* Deadman, P. _A Manual of Acupuncture_ - פרק ערוץ הלב
* Maciocia, G. _The Foundations of Chinese Medicine_ - פרקי הלב
* הואנג די ניי ג'ינג, סו וון, פרק 8: "הלב הוא השליט"

***

> **נקודה למחשבה**: הלב נקרא ברפואה הסינית "קיסר של כל האיברים" (Jūn Zhǔ Zhī Guān). בדומה לקיסר שאינו עושה את העבודה בעצמו אלא מנהל, הלב שולט על ההכרה, הרגשות והדם - והפריקרד (Xīn Bāo) משמש כ"שר הפנים" שמגן עליו. לכן, פתולוגיות רבות של "הלב" מטופלות דרך ערוץ הפריקרד.

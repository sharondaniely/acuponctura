...
1. **מתחיל באזור הג'יאו האמצעי** (Zhong Jiao) - בקיבה
...
#### 1.3 תפקודי איבר הריאות (Fei)

* **שולט בצ'י ובנשימה** - הריאות שואפות צ'י טהור ופולטות צ'י עכור
* **שולט בהפצה ובהורדה** - מפזר ווי צ'י ונוזלים לשטח; מוריד צ'י ונוזלים כלפי מטה
* **שולט בערוצים ובכלי הדם** - "כל הערוצים מגיעים לריאות"
* **שולט בעור ובשיער הגוף** - ווי צ'י מגן על העור
* **נפתח לאף** - האף הוא "השער" של הריאות
* **מאכסן את הפו** - הפו הוא ההיבט הנפשי של הריאות - אינסטינקט, תחושה גופנית
* **רגש**: עצב ואבל
...
**שם סיני**: (Zhong Fu) **משמעות השם**: "ארמון האמצע" — נקודת המפגש של צ'י הריאות עם ג'יאו האמצעי **קטגוריה מיוחדת**: נקודת מו קדמית (Mu Xue) של הריאות; נקודת מפגש עם ערוץ הטחול

**מיקום אנטומי**

6 צון לטרלית לקו האמצע הקדמי, ברווח הבין-צלעי הראשון. 1 צון מתחת ל-LU2.
...
**שם סיני**: (Yun Men) **משמעות השם**: "שער העננים" — השער שדרכו צ'י הריאות מתפשט כמו עננים
...
**שם סיני**: (Tian Fu) **משמעות השם**: "ארמון השמיים" — נקודה גבוהה בזרוע הקשורה לריאות (שמיים) **קטגוריה מיוחדת**: נקודת חלון השמיים (Tian Chuang Xue)
...
**שם סיני**: (Xia Bai) **משמעות השם**: "לוחם הלבן" — לבן הוא צבע הריאות (מתכת)
...
**שם סיני**: (Chi Ze) **משמעות השם**: "ביצת הצ'י" (צ'י = יחידת מדידה של האמה; צה = ביצה/מאגר מים) — מאגר מים של ערוץ הריאות **קטגוריה מיוחדת**: נקודת הה-ים (He Xue) — אלמנט מים (Shui)
...
**שם סיני**: (Kong Zui) **משמעות השם**: "חור האוסף" — נקודה שבה צ'י הריאות מתאסף בעומק **קטגוריה מיוחדת**: נקודת שי-צלע (Xi Xue) — נקודת חירום/כאב חריף של הערוץ
...
**שם סיני**: (Lie Que) **משמעות השם**: "סדרת הפגמים" או "ברק" — הנקודה נמצאת בשקע (פגם) בעצם הרדיוס **קטגוריה מיוחדת**: נקודת לואו מחברת (Luo Xue); נקודת פתיחה של רן מאי; אחת מ-4 נקודות הפיקוד; נקודת מפגש עם ערוץ המעי הגס
...
* **פעולות**: משחרר שטח (Shi Biao) — מגרש רוח וקור; מפתח ומווסת רן מאי; מועיל לראש ולעורף; מפזר צ'י ריאות; מועיל לדרכי השתן
* **כנקודת פיקוד**: "הראש והעורף — ליה צ'יואה גוששת"
...
**שם סיני**: (Jing Qu) **משמעות השם**: "תעלת הערוץ" — נקודה שבה הצ'י זורם כמו מים בתעלה **קטגוריה מיוחדת**: נקודת ג'ינג-נהר (Jing Xue) — אלמנט מתכת (Jin)
...
**שם סיני**: (Tai Yuan) **משמעות השם**: "התהום הגדול" — מאגר עמוק של צ'י **קטגוריה מיוחדת**: נקודת יואן-מקור (Yuan Xue); נקודת שו-זרם (Shu Xue) — אלמנט אדמה (Tu); נקודת מפגש של כלי הדם (Ba Hui Xue — Mai Hui Tai Yuan)
...
* **כנקודת יואן**: מחברת לצ'י המקורי של הריאות — נקודה מרכזית לכל בעיה כרונית של הריאות
...
**שם סיני**: (Yu Ji) **משמעות השם**: "גבול הדג" — האזור הבשרני של כף היד ליד האגודל דומה לצורת דג **קטגוריה מיוחדת**: נקודת יינג-מעיין (Ying Xue) — אלמנט אש (Huo)
...
**שם סיני**: (Shao Shang) **משמעות השם**: "מסחר קטן" — שאנג הוא הצליל של אלמנט המתכת; שאו = קטן — הנקודה הקטנה שבקצה **קטגוריה מיוחדת**: נקודת ג'ינג-באר (Jing Xue) — אלמנט עץ (Mu)
...
* **שיטה**: בעיקר הוצאת דם (Fang Xue) — דקירה מהירה עם מחט משולשת או מחט לנסט
...
| ------------------------ | ----- | ----------------------------- |
| מו קדמית (Front Mu) | LU1 | אבחון וטיפול בריאות |
| הה-ים (He-Sea) | LU5 | מצבים כרוניים, חום בריאות |
| שי-צלע (Xi-Cleft) | LU6 | מצבי חירום, כאב חריף, דימום |
| לואו (Luo-Connecting) | LU7 | חיבור ל-LI, ראש ועורף, רן מאי |
| ג'ינג-נהר (Jing-River) | LU8 | שיעול, חום |
| יואן-מקור (Yuan-Source) | LU9 | חיזוק ריאות, מצבים כרוניים |
| יינג-מעיין (Ying-Spring) | LU10 | פינוי חום, כאב גרון |
| ג'ינג-באר (Jing-Well) | LU11 | חירום, חום גבוה, אובדן הכרה |
| שו-זרם (Shu-Stream) | LU9 | כאבי מפרקים, רטיבות |

***

### 4. חמש נקודות שו (Wu Shu Xue) של ערוץ הריאות

| סוג | נקודה | אלמנט | כיוון הזרימה |
| -------------------------- | ----- | -------- | ------------ |
| ג'ינג-באר (Jing-Well) | LU11 | עץ | הצ'י "נובע" |
| יינג-מעיין (Ying-Spring) | LU10 | אש | הצ'י "זורם" |
| שו-זרם (Shu-Stream) | LU9 | אדמה | הצ'י "מתחזק" |
| ג'ינג-נהר (Jing-River) | LU8 | מתכת | הצ'י "גדל" |
| הה-ים (He-Sea) | LU5 | מים | הצ'י "מתאסף" |

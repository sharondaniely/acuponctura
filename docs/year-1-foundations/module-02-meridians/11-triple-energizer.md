...
## ערוץ שלוש המבערות - שו שאו יאנג סאן ג'יאו
...
ערוץ שלוש המבערות (שו שאו יאנג -) הוא הערוץ החיצוני (יאנג) המזווג עם ערוץ קרום הלב (שו ג'יואה ין -), שהוא הערוץ הפנימי (ין). שניהם שייכים לאש המיניסטריאלית.

***

### 2. תפקודי שלוש המבערות (Sān Jiāo)

#### 2.1 שלוש המבערות

שלוש המבערות הוא "איבר" ייחודי ברפואה הסינית — יש לו תפקוד אך אין לו צורה פיזית ברורה. הוא מחולק לשלוש קומות:

| מבערה | מיקום | תפקיד | איברים |
| --------------- | ---------------- | ---------------------------------- | -------------------------- |
| **עליונה** | מעל הסרעפת | "כמו ערפל" — מפזרת צ'י ונוזלים | לב, ריאות, קרום הלב |
| **אמצעית** | בין הסרעפת לטבור | "כמו בועות רותחות" — מעכלת ומפרידה | קיבה, טחול |
| **תחתונה** | מתחת לטבור | "כמו תעלת ניקוז" — מפרישה ומסלקת | כליות, שלפוחית, כבד, מעיים |

#### 2.2 תפקודים עיקריים

1. **שליטה על מעברי המים** - שלוש המבערות שולטות על תנועת הנוזלים בכל הגוף, משמשות כ"מערכת ההשקיה" של הגוף.
2. **הובלת צ'י** - שלוש המבערות הן המסלול שדרכו הצ'י המקורית (Yuán Qì) מופצת לכל הגוף.
...
#### TE1 — גואן צ'ונג — Guān Chōng — "מעבר פגיעה"
...
#### TE3 — ג'ונג ג'ו — Zhōng Zhǔ — "אי מרכזי"
...
**קטגוריה מיוחדת:** נקודת שו-זרם, נקודת עץ
...
* TE3 + GB41 — פתיחת דאי מאי — לטיפול בכאבי צד, בעיות אוזניים, כאב ראש צידי
* TE3 + TE5 — לכאב בזרוע ובכתף
* TE3 + SI19 + GB2 — לטיפול בטינטון וחירשות

***

#### TE4 — יאנג צ'י — Yáng Chí — "בריכת היאנג"
...
* מחזקת את צ'י המקור דרך שלוש המבערות
* מפזרת רוח-חום
...
#### TE5 — וואי גואן — Wài Guān — "מעבר חיצוני"
...
**קטגוריה מיוחדת:** נקודת לואו-מחברת, אחת מ-8 נקודות המפגש — מחוברת ליאנג ווי מאי
...
* מפזרת רוח-חום, משחררת את החיצוני
* מנקה חום, מורידה חום
...
* TE5 + GB41 — פתיחת דאי מאי + יאנג ווי מאי — לכאבי צד, אוזניים, כאב ראש
...
**קטגוריה מיוחדת:** נקודת ג'ינג-נהר, נקודת אש
...
#### TE7 — הוי צונג — Huì Zōng — "מפגש שושלות"
...
#### TE8 — סאן יאנג לואו — Sān Yáng Luò — "חיבור שלושת היאנג"
...
#### TE10 — טיאן ג'ינג — Tiān Jǐng — "באר שמימית"
...
**קטגוריה מיוחדת:** נקודת הא-ים, נקודת אדמה
...
#### TE11 — צ'ינג לנג יואן — Qīng Lěng Yuān — "תהום צלולה וקרה"
...
#### TE12 — שיאו לואו — Xiāo Luò — "התכה מתפזרת"
...
#### TE13 — נאו הוי — Nào Huì — "מפגש הזרוע"
...
#### TE14 — ג'יאן ליאו — Jiān Liáo — "שקע הכתף"
...
#### TE15 — טיאן ליאו — Tiān Liáo — "שקע שמימי"
...
#### TE16 — טיאן יו — Tiān Yǒu — "חלון שמיים"
...
**קטגוריה מיוחדת:** נקודת חלון השמיים
...
#### TE18 — צ'י מאי — Chì Mài — "כלי העווית"
...
#### TE19 — לו שי — Lú Xī — "מנוחת הגולגולת"
...
#### TE20 — ג'יאו סון — Jiǎo Sūn — "זווית האוזן"
...
#### TE22 — הא ליאו — Hé Liáo — "שקע הרמוניה"
...
#### TE23 — סי ג'ו קונג — Sī Zhú Kōng — "חלל משי הבמבוק"
...
| נקודת לואו | TE5 |
| נקודת שי | TE7 |
| 8 נקודות מפגש | TE5 (יאנג ווי מאי) |

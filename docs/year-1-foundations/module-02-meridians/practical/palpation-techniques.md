...
כל נקודת דיקור (Xue Wei, פירוש מילולי: "חור") היא אזור קטן ברקמה שבו:
...
> ברפואה הסינית אומרים: (You Zhu Nei Bi Xing Zhu Wai) — "מה שקיים בפנים בהכרח מתבטא בחוץ"
...
### 3.1 מישוש בקצה אצבע (Zhi Jian An Ya)
...
### 3.2 מישוש בכרית אצבע (Zhi Fu An Ya)
...
### 3.3 מישוש בשתי אצבעות (Shuang Zhi An Ya)
...
### 3.4 מישוש בהחלקה (Hua Dong Chu Zhen / Gliding Palpation)
...
### 3.5 מישוש בלחיצה עמוקה (Shen An / Deep Palpation)
...
### 4.3 שינוי מרקם (Texture Change - Jie Jie)
...
- שימו לב לשינויי צבע סביב נקודות **שו** (Bei Shu Xue) בגב
...
### 7.1 מישוש נקודות שו בגב (Bei Shu Xue)

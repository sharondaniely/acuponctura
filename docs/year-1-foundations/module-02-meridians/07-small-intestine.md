...
## ערוץ המעי הדק - שו טאי יאנג שיאו צ'אנג
...
| פרט | תיאור |
| -------------------- | -------------------------------------- |
| **שם סיני** | (Shǒu Tài Yáng Xiǎo Cháng Jīng) |
| **קיצור** | SI (Small Intestine) |
| **מספר נקודות** | 19 |
| **סוג** | יאנג (Yang) |
| **אלמנט** | אש (Huǒ) |
| **זוג פנימי-חיצוני** | לב (HT) |
...
מהבור העל-שכמי (supraclavicular fossa), ענף פנימי יורד אל הלב (Xīn) ומשם יורד לאורך הוושט, חוצה את הסרעפת, עובר דרך הקיבה ומגיע אל **המעי הדק** (Xiǎo Cháng) - האיבר השייך לו.

ענף נוסף עולה מהבור העל-שכמי לאורך הצוואר ללחי, ומגיע לאזור מתחת לעין ולאוזן הפנימית.

#### 1.3 זיווג פנימי-חיצוני

ערוץ המעי הדק (יאנג) מזווג עם ערוץ הלב (ין). שניהם שייכים לאלמנט האש (Huǒ):

* **הלב** (ין) - שולט על הדם, מאכלס את הרוח
* **המעי הדק** (יאנג) - מפריד בין טהור (Qīng) לעכור (Zhuó)

הקשר הקליני: חום בלב יכול לרדת למעי הדק ולגרום: צריבה בהשתנה, שתן כהה, דם בשתן. בנוסף, בעיות רגשיות של הלב (חרדה, עצבנות) משפיעות על העיכול דרך המעי הדק.
...
1. **שליטה על קבלה ופירוק** (Shòu Chéng Huà Wù): המעי הדק מקבל מזון מעוכל חלקית מהקיבה וממשיך את תהליך העיכול.
2. **הפרדה בין טהור לעכור** (Mì Bié Qīng Zhuó): זהו התפקיד המרכזי - המעי הדק מפריד:
   * **טהור** (Qīng): חומרים מזינים → נשלחים לטחול להפצה
   * **עכור מוצק** → נשלח למעי הגס להפרשה
   * **עכור נוזלי** → נשלח לשלפוחית השתן
...
| ---------------------------------- | ---------------------------------------------------------------- |
| **חום במעי הדק** | כאבי בטן תחתונה, צריבה בהשתנה, שתן כהה, כיבים בפה (חום עולה מלב) |
| **חסר וקור במעי הדק** | כאבי בטן עמומים שמשתפרים בחום ובלחיצה, בורבוריגמוס, שלשול |
| **סטגנציה של צ'י במעי הדק** | כאבי בטן תחתונה, נפיחות, הרניה מפשעתית |
...
**קטגוריה מיוחדת**: נקודת יינג-מעיין (Yíng) - אלמנט מים
...
* **פותחת את דו מאי** (Dū Mài) - כאבי גב, נוקשות צוואר, כאבי עמוד שדרה
...
**קטגוריה מיוחדת**: נקודת שו-זרם (Shū) - אלמנט עץ; **נקודת פתיחה של דו מאי** (Dū Mài) - ערוץ המושל (Governing Vessel)
...
* מפנה רטיבות-חום - צהבת (Huáng Dǎn), שלשול
...
**קטגוריה מיוחדת**: **נקודת יואן-מקור** (Yuán Xué)
...
**קטגוריה מיוחדת**: נקודת ג'ינג-נהר (Jīng) - אלמנט אש
...
* יבלות (Zhuì Yóu) - שימוש מסורתי

**קטגוריה מיוחדת**: **נקודת לואו-מחברת** (Luò Xué) - מתחברת לערוץ הלב (HT)
...
**קטגוריה מיוחדת**: נקודת הה-ים (Hé) - אלמנט אדמה
...
**קטגוריה מיוחדת**: נקודת מפגש עם יאנג ווי מאי ויאנג צ'יאו מאי
...
#### SI14 - ג'יאן וואי שו - Jiān Wài Shū
...
#### SI15 - ג'יאן ג'ונג שו - Jiān Zhōng Shū
...
**קטגוריה מיוחדת**: נקודת חלון השמיים (Tiān Chuāng Xué)
...
**קטגוריה מיוחדת**: נקודת מפגש עם ערוץ שלוש המבערות (TE) וערוץ המעי הדק
...
**קטגוריה מיוחדת**: נקודת מפגש של ערוצי המעי הדק (SI), כיס המרה (GB), ושלוש המבערות (TE)
...
| נקודה | סוג | אלמנט |
| -------------- | -------------- | ----- |
| SI1 (שאו צה) | ג'ינג-באר | מתכת |
| SI2 (צ'יאן גו) | יינג-מעיין | מים |
| SI3 (הואו שי) | שו-זרם | עץ |
| SI5 (יאנג גו) | ג'ינג-נהר | אש |
| SI8 (שיאו האי) | הה-ים | אדמה |

#### נקודות מיוחדות נוספות

| נקודה | קטגוריה |
| ------------------ | ------------------------------ |
| SI3 (הואו שי) | שו-זרם; פתיחת דו מאי |
| SI4 (וואן גו) | יואן - מקור |
| SI7 (ג'י ג'נג) | לואו - מחברת |
| SI16 (טיאן צ'ואנג) | חלון השמיים |

...
| **זוג פנים-חוץ** | כיס המרה (GB -) |

#### 1.2 מסלול הערוץ

**מסלול חיצוני:** הערוץ מתחיל בצד הלטרלי של אצבע הרגל הגדולה (LR1), עולה על גב הרגל (LR2-LR4), עובר את המלאולוס המדיאלי (LR4-LR5), עולה לאורך הצד המדיאלי של השוק (LR5-LR8) — שם הוא חוצה את ערוץ הטחול (SP) בנקודה SP6. הערוץ ממשיך לצד המדיאלי של הברך (LR8), עולה לאורך הצד המדיאלי של הירך, עוטף את אזור המין, ועולה לבטן התחתונה (LR12-LR13). הוא מסתיים ברווח הבין-צלעי ה-6, מתחת לפטמה (LR14).

**מסלול פנימי:** מאזור המין, הערוץ הפנימי נכנס לבטן, עוטף את הקיבה, מתחבר לכבד ולכיס המרה. משם הוא עולה דרך הסרעפת, מתפשט בצלעות, עולה בצד האחורי של הגרון, מגיע לנזופרינקס (חלק העליון של הגרון), מתחבר לעיניים, ועולה למצח ולקודקוד הראש שם הוא מתחבר לכלי דו מאי.
...
ערוץ הכבד (צו ג'יואה ין -) הוא הערוץ הפנימי (ין) המזווג עם ערוץ כיס המרה (צו שאו יאנג -), שהוא הערוץ החיצוני (יאנג). שניהם שייכים לאלמנט העץ. הכבד וכיס המרה פועלים בשיתוף פעולה — הכבד מייצר מרה והכיס אוגר ומפריש אותה.

***

### 2. תפקודי איבר הכבד (Gān)

#### 2.1 תפקודים עיקריים

1. **שליטה על זרימת הצ'י (Shū Xiè)** - הכבד אחראי על זרימה חלקה וחופשית של הצ'י בכל הגוף. זהו התפקיד החשוב ביותר של הכבד. סטגנציית צ'י הכבד היא אחד הדפוסים הנפוצים ביותר בקליניקה.
2. **אחסון דם (Cáng Xuè)** - הכבד אוגר דם ומווסת את כמות הדם שמסתובבת בגוף בהתאם לפעילות. בזמן מנוחה ושינה, דם חוזר לכבד; בזמן פעילות, דם משוחרר לגפיים.
3. **שליטה על הגידים (Jīn)** - הכבד מזין את הגידים, הרצועות והשרירים. חוסר דם כבד מוביל לעוויתות, רעד, נימול וקשיחות.
...
6. **שליטה על התכנון (Móu Lüè)** - הכבד הוא "הגנרל" — אחראי על תכנון אסטרטגי, קבלת החלטות ויכולת ארגון.

#### 2.2 רגש ומנטלי

* **רגש**: כעס (Nù) — כולל תסכול, עצבנות, מרירות, דיכאון מודחק
* **רוח (Hún)**: נשמה אתרית — דמיון, חזון, חלומות, תכנון לעתיד
...
**מיקום אנטומי:** בצד הלטרלי של אצבע הרגל הגדולה, 0.1 צון פרוקסימלית לזווית הציפורן.
...
#### LR2 — שינג ג'יאן — Xíng Jiān — "מרווח הליכה"
...
**קטגוריה מיוחדת:** נקודת יינג-מעיין, נקודת אש, נקודת הרגעה/ניקוז (נקודת הבן)
...
#### LR3 — טאי צ'ונג — Tài Chōng — "שטף גדול"
...
**מיקום אנטומי:** בגב הרגל, בשקע שבין עצמות המטטרסל ה-1 וה-2, פרוקסימלית למפגש של עצמות המטטרסל.
...
* LR3 + LI4 — "ארבעת השערים" (Sì Guān) — לפיזור סטגנציה, הרגעת הרוח, כאב ראש
...
#### LR4 — ג'ונג פנג — Zhōng Fēng — "חותם מרכזי"
...
**מיקום אנטומי:** 1 צון קדימה (אנטריורית) למלאולוס המדיאלי (הקרסול הפנימי), בשקע שעל גיד שריר הטיביאליס אנטריור, כאשר כף הרגל בדורסיפלקסיה.
...
#### LR5 — לי גו — Lǐ Gōu — "חריץ התולעת"

**קטגוריה מיוחדת:** נקודת לואו-מחברת

**מיקום אנטומי:** 5 צון מעל קצה המלאולוס המדיאלי, על השפה המדיאלית (פנימית) של עצם הטיביה.
...
#### LR6 — ג'ונג דו — Zhōng Dū — "בירה מרכזית"

**קטגוריה מיוחדת:** נקודת שי-צבירה

**מיקום אנטומי:** 7 צון מעל קצה המלאולוס המדיאלי, על השפה המדיאלית של עצם הטיביה.
...
#### LR7 — שי גואן — Xī Guān — "מעבר הברך"

**מיקום אנטומי:** 1 צון אחורית (פוסטריורית) ל-SP9, בשקע שעל השפה האחורית של הקונדיל המדיאלי של הטיביה.
...
#### LR8 — צ'יו צ'יואן — Qū Quán — "מעיין מתעקל"

**קטגוריה מיוחדת:** נקודת הא-ים, נקודת מים, נקודת חיזוק (נקודת האם)

**מיקום אנטומי:** בקצה המדיאלי של קפל הברך, כאשר הברך מכופפת, בשקע שמעל לקונדיל המדיאלי של הטיביה, אחורית לאפיקונדיל המדיאלי של הפמור.
...
#### LR9 — ין באו — Yīn Bāo — "מעטפת הין"

**מיקום אנטומי:** 4 צון מעל האפיקונדיל המדיאלי של הפמור, בין שרירי הסרטוריוס לגרסיליס, בצד המדיאלי של הירך.
...
#### LR10 — צו וו לי — Zú Wǔ Lǐ — "חמש מיילים ברגל"

**מיקום אנטומי:** 3 צון מתחת ל-ST30 (צ'י צ'ונג), על הצד המדיאלי של הירך, על השפה הלטרלית של שריר האדוקטור לונגוס.
...
#### LR11 — ין ליאן — Yīn Lián — "זווית הין"

**מיקום אנטומי:** 2 צון מתחת ל-ST30, על הצד המדיאלי של הירך, על שריר האדוקטור לונגוס.
...
#### LR12 — ג'י מאי — Jí Mài — "דופק מהיר"

**מיקום אנטומי:** 2.5 צון לטרלית לקו האמצע, בצד הלטרלי-תחתון של עצם הערווה, בצד המדיאלי של עורק הפמורלי.
...
#### LR13 — ג'אנג מן — Zhāng Mén — "שער המניפסט"

**קטגוריה מיוחדת:** נקודת מו-קדמית של הטחול, נקודת מפגש של איברי הזאנג

**מיקום אנטומי:** בקצה חופשי של הצלע ה-11, בצד הלטרלי של הבטן.
...
#### LR14 — צ'י מן — Qī Mén — "שער המחזור"

**קטגוריה מיוחדת:** נקודת מו-קדמית של הכבד, נקודת מפגש עם ערוצי הטחול וין ווי מאי

**מיקום אנטומי:** ברווח הבין-צלעי ה-6, 4 צון לטרלית לקו האמצע, ישירות מתחת לפטמה.
...
| נקודת לואו | LR5 |
| נקודת שי | LR6 |
| נקודת מו של הכבד | LR14 |
| נקודת מו של הטחול | LR13 |
| מפגש איברי זאנג | LR13 |

...
#### 1.3 תפקודי איבר הקיבה (Wei)

* **שולטת בקבלה ובהבשלה של מזון** — "ים של מזון ושתייה"
* **שולטת בהורדה** — מורידה מזון מעובד למעי הדק
* **מקור של צ'י ודם** — יחד עם הטחול, הקיבה היא "השורש של שמיים מאוחרים"
...
**שם סיני**: (Cheng Qi) **משמעות השם**: "מקבל דמעות" — הנקודה מתחת לעין, מקום שבו דמעות נאספות **קטגוריה מיוחדת**: נקודת מפגש עם יאנג צ'יאו מאי ורן מאי
...
**שם סיני**: (Si Bai) **משמעות השם**: "ארבעה לבנים" — מהנקודה ניתן לראות לבן לארבע כיוונים (שדה ראייה)
...
**שם סיני**: (Ju Liao) **משמעות השם**: "שקע גדול" — הגומה מתחת לעצם הלחי
...
**שם סיני**: (Di Cang) **משמעות השם**: "מחסן הארץ" — ליד הפה, "מחסן" המזון; אדמה = קיבה/טחול
...
**שם סיני**: (Da Ying) **משמעות השם**: "קבלת פנים גדולה" — נקודה על עצם הלחי שבה "מקבלים" את הערוץ
...
**שם סיני**: (Jia Che) **משמעות השם**: "גלגל הלחי" — הנקודה על שריר הלעיסה, "גלגל" הלחי
...
**שם סיני**: (Xia Guan) **משמעות השם**: "מפרק תחתון" — מתחת ל-Zygomatic Arch, ליד מפרק הלסת (TMJ) **קטגוריה מיוחדת**: נקודת מפגש עם ערוץ כיס המרה (GB)
...
**שם סיני**: (Tou Wei) **משמעות השם**: "פינת הראש" — בפינה הקדמית-צידית של קו השיער **קטגוריה מיוחדת**: נקודת מפגש עם ערוץ כיס המרה (GB) ויאנג ווי מאי
...
**שם סיני**: (Ren Ying) **משמעות השם**: "קבלת אדם" — נקודה שבה ניתן לגשש את דופק ה"קבלה" **קטגוריה מיוחדת**: נקודה על עורק הקרוטיד; נקודת חלון השמיים
...
**שם סיני**: (Shui Tu) **משמעות השם**: "בליטת המים" — ליד תפוח האדם שבולט כ"מים" (רוק) כשבולעים
...
**שם סיני**: (Qi She) **משמעות השם**: "בית הצ'י" — מקום שבו צ'י שוכן
...
**שם סיני**: (Que Pen) **משמעות השם**: "אגן שבור" — הגומה שמעל לבריח נראית כמו אגן
...
**שם סיני**: (Qi Hu) **משמעות השם**: "דלת הצ'י" — שער הכניסה של צ'י לחזה
...
**ST14 — קו פאנג** "חדר האוצר" — ברווח הבין-צלעי הראשון, 4 צון לטרלית. שיעול, כאב חזה.

**ST15 — וו יי** "גג הבית" — ברווח הבין-צלעי השני, 4 צון לטרלית. שיעול, כאב חזה, מסטיטיס.

**ST16 — יינג צ'ואנג** "חלון החזה" — ברווח הבין-צלעי השלישי, 4 צון לטרלית. כאב חזה, שיעול, נפיחות שד.

**ST17 — רו ג'ונג** "מרכז השד" — על הפטמה. **אסור לדקור** — נקודת ציון בלבד לצורך מדידה. הפטמה נמצאת ברווח הבין-צלעי הרביעי, 4 צון לטרלית.
...
**שם סיני**: (Ru Gen) **משמעות השם**: "שורש השד" — בבסיס (שורש) השד
...
**שם סיני**: (Bu Rong) **משמעות השם**: "לא מכיל" — כאשר הקיבה מלאה ולא יכולה להכיל עוד
...
**ST20 — צ'נג מאן** "מקבל מלאות" — 5 צון מעל הטבור, 2 צון לטרלית. כאב קיבה, הקאות.

**ST21 — ליאנג מן** "שער הגשר" — 4 צון מעל הטבור, 2 צון לטרלית. **נקודה חשובה** — כאב קיבה, חוסר תיאבון, שלשול. שילוב: ST21 + REN12 + ST36 (בעיות קיבה כרוניות).
...
**ST22 — גואן מן** "שער הסגירה" — 3 צון מעל הטבור, 2 צון לטרלית. נפיחות בטנית, בצקות, שלשול.

**ST23 — טאי יי** "אחדות גדולה" — 2 צון מעל הטבור, 2 צון לטרלית. כאב קיבה, אי-שקט נפשי, מאניה.

**ST24 — הואה רו מן** "שער הבשר החלקלק" — 1 צון מעל הטבור, 2 צון לטרלית. הקאות, מאניה.

***

#### ST25 — טיאן שו

**שם סיני**: (Tian Shu) **משמעות השם**: "ציר השמיים" — הציר שבין ג'יאו עליון (שמיים) לג'יאו תחתון (ארץ) **קטגוריה מיוחדת**: נקודת מו קדמית (Mu Xue) של המעי הגס; נקודה מהחשובות בבטן
...
**ST26 — וואי לינג** "גבעה חיצונית" — 1 צון מתחת לטבור, 2 צון לטרלית. כאב בטן, דיסמנוריאה.

**ST27 — דה ג'ו** "גדול ענק" — 2 צון מתחת לטבור, 2 צון לטרלית. כאב בטן תחתון, עצירות, בעיות שתן, אין-פוטנציה (Impotence).

**ST28 — שואי דאו** "מסלול המים" — 3 צון מתחת לטבור, 2 צון לטרלית. **נקודה חשובה למים** — בצקות, עצירת שתן, כאב מחזור, כאב בטן תחתון. שילוב: ST28 + REN3 + SP9 (בעיות שתן, בצקות).
...
**שם סיני**: (Gui Lai) **משמעות השם**: "חזרה" — הצ'י חוזר; גם במשמעות של החזרת הרחם למקומו
...
**שם סיני**: (Qi Chong) **משמעות השם**: "פריצת צ'י" — מקום שבו צ'י פורצת החוצה **קטגוריה מיוחדת**: נקודת מפגש עם צ'ונג מאי
...
**שם סיני**: (Bi Guan) **משמעות השם**: "שער הירך" — בי = ירך; גואן = שער/מפרק
...
**שם סיני**: (Fu Tu) **משמעות השם**: "ארנב רובץ" — בליטת שריר הקוואדריצפס נראית כארנב רובץ
...
**שם סיני**: (Yin Shi) **משמעות השם**: "שוק הין" — אזור שבו צ'י ין מתאסף
...
**שם סיני**: (Liang Qiu) **משמעות השם**: "גבעת הגשר" — בליטת השריר כמו גבעה ליד "גשר" הברך **קטגוריה מיוחדת**: נקודת שי-צלע (Xi Xue) — נקודת חירום/כאב חריף של הערוץ
...
**שם סיני**: (Du Bi) **משמעות השם**: "אף העגל" — הגומה מתחת לפיקה נראית כמו נחיר של עגל **קטגוריה מיוחדת**: נקודה מרכזית לברך
...
**שם סיני**: (Zu San Li) **משמעות השם**: "שלושה לי של הרגל" — 3 צון מתחת לברך; "שלוש נסיעות" — אמרה סינית: "מי שדוקר צו סאן לי יכול ללכת שלושה לי נוספים" **קטגוריה מיוחדת**: נקודת הה-ים (He Xue) — אלמנט אדמה (Tu); אחת מ-4 נקודות הפיקוד; נקודת הה-ים התחתונה של הקיבה; נקודת "ים של מזון"
...
* **כנקודת פיקוד**: "הבטן — צו סאן לי שומרת"
* **התוויות**: כאב קיבה, בחילה, הקאות, שלשול, עצירות, נפיחות בטנית, חולשה כללית, עייפות כרונית, חום, סחרחורת, דיכאון, חרדה, כאב ברך, שיתוק רגל, חיזוק חיסוני, אריכות ימים (בשימוש מוקסה), מצבים כרוניים רבים
...
**שם סיני**: (Shang Ju Xu) **משמעות השם**: "ריקנות עליונה גדולה" — הגומה שבין עצם השוקה לשריר **קטגוריה מיוחדת**: נקודת הה-ים התחתונה (Xia He Xue) של המעי הגס
...
**שם סיני**: (Tiao Kou) **משמעות השם**: "פתח צר" — פתח צר בין עצמות השוקה
...
**שם סיני**: (Xia Ju Xu) **משמעות השם**: "ריקנות תחתונה גדולה" **קטגוריה מיוחדת**: נקודת הה-ים התחתונה של המעי הדק
...
**שם סיני**: (Feng Long) **משמעות השם**: "שפע ושגשוג" — הנקודה על בליטה שרירית שופעת **קטגוריה מיוחדת**: נקודת לואו מחברת (Luo Xue); **הנקודה המרכזית לטיפול בליחה (Tan)**
...
**שם סיני**: (Jie Xi) **משמעות השם**: "פיצול הנחל" — הנקודה בקפל שבין השוקה לכף הרגל **קטגוריה מיוחדת**: נקודת ג'ינג-נהר (Jing Xue) — אלמנט אש (Huo)
...
**שם סיני**: (Chong Yang) **משמעות השם**: "פורץ היאנג" — מקום שבו דופק יאנג (של הקיבה) מורגש **קטגוריה מיוחדת**: נקודת יואן-מקור (Yuan Xue)
...
**שם סיני**: (Xian Gu) **משמעות השם**: "עמק שוקע" — הגומה בין עצמות המטטרסל **קטגוריה מיוחדת**: נקודת שו-זרם (Shu Xue) — אלמנט עץ (Mu)
...
**שם סיני**: (Nei Ting) **משמעות השם**: "חצר פנימית" — בכניסה (חצר) בין האצבעות **קטגוריה מיוחדת**: נקודת יינג-מעיין (Ying Xue) — אלמנט מים (Shui)
...
**שם סיני**: (Li Dui) **משמעות השם**: "החלפה חמורה" — נקודת הסיום שבה הצ'י מחליף ערוץ **קטגוריה מיוחדת**: נקודת ג'ינג-באר (Jing Xue) — אלמנט מתכת (Jin)
...
* **שיטה**: בעיקר הוצאת דם עם מחט משולשת
* **עומק**: 0.1 צון
...
| קטגוריה | נקודה | שימוש עיקרי |
| ------------------------ | ----- | -------------------------- |
| ג'ינג-באר (Jing-Well) | ST45 | חירום, חום, אובדן הכרה |
| יינג-מעיין (Ying-Spring) | ST44 | פינוי חום-קיבה, כאב שיניים |
| שו-זרם (Shu-Stream) | ST43 | בצקות, רטיבות |
| ג'ינג-נהר (Jing-River) | ST41 | חום, כאב ראש, קרסול |
| הה-ים (He-Sea) | ST36 | חיזוק עיכול, כל בעיות בטן |
| יואן-מקור (Yuan-Source) | ST42 | חיזוק קיבה, מאניה |
| לואו (Luo-Connecting) | ST40 | ליחה (כל סוג) |
| שי-צלע (Xi-Cleft) | ST34 | כאב קיבה חריף, כאב ברך |
| מו קדמית של מעי גס | ST25 | בעיות מעי גס |
| הה-ים תחתונה — מעי גס | ST37 | בעיות מעי גס ישירות |
| הה-ים תחתונה — מעי דק | ST39 | בעיות מעי דק |

***

### 10. חמש נקודות שו של ערוץ הקיבה

| סוג | נקודה | אלמנט | כיוון הזרימה |
| -------------------------- | ----- | -------- | ------------ |
| ג'ינג-באר (Jing-Well) | ST45 | מתכת | הצ'י "נובע" |
| יינג-מעיין (Ying-Spring) | ST44 | מים | הצ'י "זורם" |
| שו-זרם (Shu-Stream) | ST43 | עץ | הצ'י "מתחזק" |
| ג'ינג-נהר (Jing-River) | ST41 | אש | הצ'י "גדל" |
| הה-ים (He-Sea) | ST36 | אדמה | הצ'י "מתאסף" |
